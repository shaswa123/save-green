                ...
                <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <form class="form-inline my-2 my-lg-0">
                        <input class="form-control mr-sm-2" type="search" placeholder="2020/05/04" aria-label="Search">
                        to
                        <input class="form-control mr-sm-2" type="search" placeholder="2020/0510" aria-label="Search">
        ...
        <div class="my-info col-sm-4">
            <h2>Your info</h2>
              <div class="nameContainer">
                  ...
                  <!-- <input class="form-control mr-sm-2" type="text" placeholder="Username" aria-label="text"> -->
              </div>
              <?php 
                if(isset($user["lastName"]) && $user["lastName"] != ""){
                  echo('
                        <div class="nameContainer">
                          ...
                          <!-- <input class="form-control mr-sm-2" type="text" placeholder="First Name" aria-label="text"> -->
                        </div>
                  ');
                }
              ?>
              <div class="emailContainer">
                  ...
                  <!-- <input class="form-control mr-sm-2" type="text" placeholder="Email ID" aria-label="text"> -->
              </div>
              <div class="nameContainer">
                <p id="name">Phone Number</p>
                <p style="font-weight:500;"><?= $phoneNum[0]["phonenum"] ?></p>
                <!-- <input class="form-control mr-sm-2" type="text" placeholder="Website" aria-label="text"> -->
              </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="POST">
                          ...
                          <div class="emailContainer">
                              <p id="email">Email</p>
                              <input class="form-control mr-sm-2" type="text" name="emailId" value="<?=$user["emailId"]?>" placeholder="Email ID" aria-label="text">
                          </div>
                          <div class="nameContainer">
                            <p id="name">Phone Number</p>
